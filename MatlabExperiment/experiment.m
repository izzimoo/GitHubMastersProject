...
if ~exist('./ExperimentResults/EEGExperiment_Participant5', 'dir')
    mkdir('./ExperimentResults/EEGExperiment_Participant5')
end
...
% % CRASH: Uncomment this
% table1 = readtable('./ExperimentResults/EEGExperiment_Participant5/DecisionsAndTimings.txt');
...
% itr = trialStopNum;
% 
% table2 = readtable('./ExperimentResults/EEGExperiment_Participant5/DecisionsAndTimings.txt');
...
% itr2 = trialStopNum;
% 
% table3 = readtable('./ExperimentResults/EEGExperiment_Participant5/ScoreUpdateAndCurrentScore.txt');
...
% itr4 = trialStopNum;
% 
% table4 = readtable('./ExperimentResults/EEGExperiment_Participant5/ScoreUpdateAndCurrentScore.txt');
...
% CRASH: Set this to the number in participantScore
participantScore = 0;      
...
%         io64(ioObj, port,0)
        ...
        writetable(T, './ExperimentResults/EEGExperiment_Participant5/DecisionsAndTimings.txt');
        ...
        writetable(T2, './ExperimentResults/EEGExperiment_Participant5/ScoreUpdateAndCurrentScore.txt'); 
