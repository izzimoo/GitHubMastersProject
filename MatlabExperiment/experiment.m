...
if ~exist('./ExperimentResults/EEGExperiment_Participant6', 'dir')
    mkdir('./ExperimentResults/EEGExperiment_Participant6')
end
...
% table1 = readtable('./ExperimentResults/EEGExperiment_Participant6/DecisionsAndTimings.txt');
...
% itr = trialStopNum;
% 
% table2 = readtable('./ExperimentResults/EEGExperiment_Participant6/DecisionsAndTimings.txt');
...
% itr2 = trialStopNum;
% 
% table3 = readtable('./ExperimentResults/EEGExperiment_Participant6/ScoreUpdateAndCurrentScore.txt');
...
% itr4 = trialStopNum;
% 
% table4 = readtable('./ExperimentResults/EEGExperiment_Participant6/ScoreUpdateAndCurrentScore.txt');
...
%         io64(ioObj, port,0)
        ...
        writetable(T, './ExperimentResults/EEGExperiment_Participant6/DecisionsAndTimings.txt');
        ...
        writetable(T2, './ExperimentResults/EEGExperiment_Participant6/ScoreUpdateAndCurrentScore.txt'); 
